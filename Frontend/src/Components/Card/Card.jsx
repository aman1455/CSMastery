...
<div
  class="group flex flex-col justify-start items-start gap-2  duration-500 relative rounded-lg p-2 sm:p-4  bg-gray-1000 hover:-translate-y-2 hover:shadow-xl shadow-gray-800 w-11/12 min-h-4/5 md:min-w-3/4 md:min-h-3/5 sm:min-h-2/3 sm:w-4/5"
>
  <div
    alt="image here"
  ...
  >
    ...
    <Link to='/product' type="button" class="text-gray-900 bg-gradient-to-r from-[#F43F5E] via-[#8B5CF6] to-[#8B5CF6] text-[#E2E8F0] hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-lime-300 dark:focus:ring-lime-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mt-6">Explore</Link>
